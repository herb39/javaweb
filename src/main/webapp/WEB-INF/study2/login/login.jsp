			...
			<table class="table table-bordered text-center">
				...
				<tr>
					<td colspan="2">
						...
						<input type="button" value="회원가입" onclick="location.href='${ctp}/____________________________________________________________/Join.re';" class="btn btn-primary mt-2 mr-3">
