...
<body>
	...
	<div class="container">	
		<h2>회원가입2</h2>
		<form name="myform" method="post" action="${ctp}/databasetrsobiehgiosgvsflkwpvrseiojpgbs/JoinOk.re">
			<table class="table text-center">
				...
				<tr>
					<td colspan="2" class="text-center">
						...
						<input type="button" value="돌아가기" onclick="location.href='${ctp}/study/0428_database/login.jsp';" class="btn btn-warning mr-2" />
					</td>
				</tr>
			</table>
		</form>
